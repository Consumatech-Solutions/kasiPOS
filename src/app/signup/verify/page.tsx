...
function VerifySignupContent() {
  ...
  const submitVerification = useCallback(
    ...
    [email, login, queryClient, router, setSetting, isDev]
  );
  ...
  const title = channel === "sms" ? "Verify your mobile" : "Verify your email";
  const description =
    channel === "sms"
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              ...
              <Button
                ...
                disabled={
                  form.watch("code").length < OTP_LENGTH || isSubmitting
                }
              >
                {isSubmitting && (
