...
>(({ className, children, title, hideOverlay, overlayClassName, ...props }, ref) => {
  ...
  const baseOverlayClass = "fixed inset-0 z-50 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0";
  
  return (
  <DialogPortal>
    {!hideOverlay && (hasHighZIndex ? (
      <DialogPrimitive.Overlay
        className={cn("fixed inset-0 z-[110] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0", overlayClassName ?? "bg-black/80")}
      />
    ) : overlayClassName ? (
      <DialogPrimitive.Overlay className={cn(baseOverlayClass, overlayClassName)} />
    ) : (
      <DialogOverlay />
    ))}
